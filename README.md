...
Part A: Train VAE on laser images. Files: train_vae_oam.py, train_ddpm_latent.py 
Part B: Train DDPM to generate VAE mean vectors. Files: train_ddpm_latent.py, sample_ldm.py (this generates samples from pixel DDPM *and* latent DDPM to compare visually)
